...
void debug_api_plugin::plugin_initialize(const variables_map& vm) {
...
string debug_api_plugin::call_contract_off_chain(uint64_t contract, uint64_t action, const vector<char>& binargs) const {
...
call_contract_results debug_api_plugin::call_contract( const call_contract_params& params )const {
   string s;
   fc::variant v;
   try {
